...
describe TiptopPay::Transaction do
  subject { TiptopPay::Transaction.new(attributes) }
  ...
  context do
    ...
    subject { TiptopPay::Transaction.new(default_attributes.merge(attributes)) }
    ...
    describe "#subscription" do
      ...
      context "with subscription_id" do
        ...
        specify { expect(subject.subscription).to be_instance_of(TiptopPay::Subscription) }
