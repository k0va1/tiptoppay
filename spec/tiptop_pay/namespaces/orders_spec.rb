...
describe TiptopPay::Namespaces::Orders do
  ...
  describe "#create" do
    ...
    context do
      ...
      specify { expect(subject.create(attributes)).to be_instance_of(TiptopPay::Order) }
  ...
  describe "#cancel" do
    ...
    context do
      ...
      specify { expect { subject.cancel("12345") }.to raise_error(TiptopPay::Client::GatewayError, "Error message") }
    end
  end
end
