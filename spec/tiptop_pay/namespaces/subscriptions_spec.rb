...
describe TiptopPay::Namespaces::Subscriptions do
  subject { TiptopPay::Namespaces::Subscriptions.new(TiptopPay.client) }

  describe "#find" do
    context do
      before { stub_api_request("subscriptions/get/successful").perform }

      specify { expect(subject.find("sc_8cf8a9338fb")).to be_instance_of(TiptopPay::Subscription) }
  ...
  describe "#find_all" do
    context do
      ...
      specify { expect(subject.find_all("user@example.com").first).to be_instance_of(TiptopPay::Subscription) }
  ...
  describe "#create" do
    ...
    context do
      ...
      specify { expect(subject.create(attributes)).to be_instance_of(TiptopPay::Subscription) }
  ...
  describe "#update" do
    ...
    context do
      ...
      specify { expect(subject.update("sc_8cf8a9338fb", attributes)).to be_instance_of(TiptopPay::Subscription) }
