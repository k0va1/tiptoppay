...
describe TiptopPay::Namespaces::Tokens do
  subject { TiptopPay::Namespaces::Tokens.new(TiptopPay.client, "/payments") }
  ...
  describe "#charge" do
    context "config.raise_banking_errors = true" do
      ...
      after { TiptopPay.config.raise_banking_errors = false }
