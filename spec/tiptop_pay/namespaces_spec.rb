...
describe TiptopPay::Namespaces do
  subject { TiptopPay::Client.new }

  describe "#payments" do
    specify { expect(subject.payments).to be_instance_of(TiptopPay::Namespaces::Payments) }
  end

  describe "#subscriptions" do
    specify { expect(subject.subscriptions).to be_instance_of(TiptopPay::Namespaces::Subscriptions) }
  end
